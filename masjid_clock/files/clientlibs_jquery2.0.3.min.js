...
b.fn.visible=function(c,A,F,p){if(this.length<1){return
}F=F||"both";
var B=this.length>1?this.eq(0):this,u=typeof p!=="undefined"&&p!==null,d=u?b(p):a,y=u?d.position():0,q=B.get(0),r=d.outerWidth(),h=d.outerHeight(),i=A===true?q.offsetWidth*q.offsetHeight:true;
if(typeof q.getBoundingClientRect==="function"){var l=q.getBoundingClientRect(),I=u?l.top-y.top>=0&&l.top<h+y.top:l.top>=0&&l.top<h,j=u?l.bottom-y.top>0&&l.bottom<=h+y.top:l.bottom>0&&l.bottom<=h,C=u?l.left-y.left>=0&&l.left<r+y.left:l.left>=0&&l.left<r,w=u?l.right-y.left>0&&l.right<r+y.left:l.right>0&&l.right<=r,e=c?I||j:I&&j,v=c?C||w:C&&w,e=(l.top<0&&l.bottom>h)?true:e,v=(l.left<0&&l.right>r)?true:v;
if(F==="both"){return i&&e&&v
}else{if(F==="vertical"){return i&&e
}else{if(F==="horizontal"){return i&&v
}}}}else{var s=u?0:y,m=s+h,E=d.scrollLeft(),G=E+r,H=B.position(),x=H.top,z=x+B.height(),D=H.left,o=D+B.width(),f=c===true?z:x,g=c===true?x:z,n=c===true?o:D,k=c===true?D:o;
if(F==="both"){return !!i&&((g<=m)&&(f>=s))&&((k<=G)&&(n>=E))
}else{if(F==="vertical"){return !!i&&((g<=m)&&(f>=s))
}else{if(F==="horizontal"){return !!i&&((k<=G)&&(n>=E))
}}}}}
})(jQuery);